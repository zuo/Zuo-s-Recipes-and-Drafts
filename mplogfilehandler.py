...
#
# MultiprocessRLock acquire()/release() methods patterned, to a large
# extent, after threading.RLock acquire()/release() of Python std library.
#
...
Tested under Debian GNU/Linux + Python 2.4, 2.5, 2.6 and 3.1.
"""
